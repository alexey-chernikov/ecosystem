...
snap install --classic --channel=edge intellij-idea-ultimate

# Developer packages
sudo apt install build-essential mysql-workbench giggle giggle-personal-details-plugin giggle-terminal-view-plugin virt-manager pwgen meld
